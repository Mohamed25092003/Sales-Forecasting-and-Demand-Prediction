...
def show_models(item, df_enc):
    ...
    item_model_map = {
        ...
        "Snacks": "xgboost_cosmetics.pkl",
        "Personal Care": "model_personalcare.pkl",
        "Household": "xgboost_cereal.pkl",
...
def main():
    ...
    plot_type = st.selectbox("Choose a plot type:", ["Overall Yearly Sales Trend", "Overall Sales Trend Over Time", "Monthly Revenue and Profit Trends"
     ,"Monthly Sales Over Years by Order Priority","Monthly Sales Over Years by Order Priority", "Sales Trend by Item Type",
    ...
    "Unit Price vs Units Sold", "Units Sold by Day of Month","Box plots of numeric"])
